...
tic;
format longG;
progress = waitbar(0, 'Running...', 'Name', 'Running Risk Analysis...');
total_steps = 1000;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
data_x1 = [0.638, 0.669, 0.411, 0.656, 0.333, 0.133, 0.583, 0.545, 0.448, 0.569, 0.546, 0.501, 0.436, 0.480, 0.457, 0.429, 0.368, 0.479];% [GLOBAL] CO2 hyrdrogenation conversion, %
data_x2 = [0.28, 0.35, 0.4375];                                                                % [GLOBAL] TREA_loss_rate, %
...
f_x1 = fitdist(data_x1', 'Kernel', 'Support', [0.1,1]);
...
parfor i = 1:n_kp
    ...
    saveas(gcf, ['POSTERIOR_FA_merged_parameter_',num2str(i),'.png'])
end
...
writecell( FA_Res, 'FA_Results_Merged.csv');
